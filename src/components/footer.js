...
export default function Footer() {
    ...
    return (
        <Div>
            <FooterLink href="https://drive.google.com/file/d/1WeINHXRTkeSHt_P5BQdiYNz7QgC3l43e/view?usp=sharing">Resume <FaExternalLinkAlt style={{marginLeft: `.5rem`}} size={16}/></FooterLink>
